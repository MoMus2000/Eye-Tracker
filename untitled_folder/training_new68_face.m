...
try 
      movie_path = '/Users/desouza/Desktop/JAZZ LATINO COMPILACIÓN - LATIN JAZZ COMPILATION. Música Ambiental y Relajante con sabor Jazz Latino-LIKkbJswJMA.mov';
catch e
    disp(e.message)
    debug();
end
...
Screen('PlayMovie', movie_ptr,  1, 1, 0.0);
