...
figure();
plot(edf0.Samples.posX(end - 2000:end), edf0.Samples.posY(end - 2000:end), 'x');


figure();
plot(edf2.Samples.pa(:, 2:end));


len = length(edf2.Samples.pa(:, 2:end));

disp(len);


len2 = length(edf2.Samples.posX);
