function [rootMeanSquaredError] = calcRootMeanSqErrorFunc(edf0 , edf1)
    ...
    rootMeanSquaredError = rootMeanSquaredError + error;
    
    end
    
    
    rootMeanSquaredError = power(rootMeanSquaredError, 0.5);
