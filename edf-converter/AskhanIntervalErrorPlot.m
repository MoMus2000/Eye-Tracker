...
lgd.FontSize = 8;
lgd.Orientation = 'vertical';
title("Error plots for Ashkan Trial 2 over time")
...
lgd.FontSize = 8;
lgd.Orientation = 'vertical';
title("Error plots for Ashkan Trial 3 over time")
...
lgd.FontSize = 8;
lgd.Orientation = 'vertical';
title("Error plots for Ashkan Trial 4 over time")
...
lgd.FontSize = 8;
lgd.Orientation = 'vertical';
title("Error plots for Ashkan Trial 5 over time")
