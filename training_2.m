...
% Self Try Block Start

Screen('TextSize',wPtr,fontSize);
DrawFormattedText(wPtr, 'Play Back 1 complete - Press space bar to try it yourself', 'center', 'center', 0);
Screen('Flip',wPtr);
...
Screen('TextSize',wPtr,fontSize);
DrawFormattedText(wPtr, '1', 'center', 'center', 0);
Screen('Flip',wPtr);
WaitSecs(2);
Screen('TextSize',wPtr,fontSize);
DrawFormattedText(wPtr, '2', 'center', 'center', 0);
Screen('Flip',wPtr);
WaitSecs(2);
Screen('TextSize',wPtr,fontSize);
DrawFormattedText(wPtr, '3', 'center', 'center', 0);
Screen('Flip',wPtr);
WaitSecs(2);
Screen('TextSize',wPtr,fontSize);
DrawFormattedText(wPtr, 'Start!', 'center', 'center', 0);
Screen('Flip',wPtr);
WaitSecs(1);
...
Eyelink('StartRecording');    
Eyelink('Message', 'Trying the Dance')
...
Eyelink('Message', 'Trying the Dance Complete')
Eyelink('StopRecording');

% Self Try Block Complete
...
Screen('TextSize',wPtr,fontSize);
DrawFormattedText(wPtr, 'Press space bar to try it yourself', 'center', 'center', 0);
Screen('Flip',wPtr);
